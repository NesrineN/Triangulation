...
namespace Triangulation {
    ...
    Vec Triangulate_Poly_Abs(const Vec& U, const Vec& U_prime, const Mat& P, const Mat& P_prime, const Mat& K, const Mat& Rl, const Mat& Rr, const Vec& Tl, const Vec& Tr){
        ...
        auto [U_hat, U_p_hat] = Poly::ComputeCorrectedPairsAbs(U, U_prime, F); 
